...
function registerKeychatIdentityTool(api) {
    ...
    api.registerTool({
        ...
        description: "Get the Keychat identity (npub, contact link, QR code path) for all active agent accounts. " +
...
function registerKeychatIdCommand(api) {
...
const plugin = defineChannelPluginEntry({
    id: "keychat",
    name: "Keychat",
    description: "Keychat channel plugin — sovereign identity + E2E encrypted chat. " +
...
export { requestInvoice, fetchLnurlPayMetadata, verifyPayment, formatSats, lightningAddressToLnurlp, } from "./src/lightning.js";
export { NwcClient, parseNwcUri, initNwc, getNwcClient, disconnectNwc, } from "./src/nwc.js";
