 ...
 */
export function lightningAddressToLnurlp(address) {
 ...
 */
export async function fetchLnurlPayMetadata(lightningAddress) {
 ...
 */
export async function requestInvoice(lightningAddress, amountSats, comment) {
    ...
    if (amountMsats < meta.minSendable || amountMsats > meta.maxSendable) {
        console.error(`[keychat/lightning] Amount ${amountSats} sats outside range: ${meta.minSendable / 1000}-${meta.maxSendable / 1000} sats`);
        return null;
    }
